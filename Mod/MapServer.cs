        ...
        internal class WSHandler : WebSocketBehavior
        {
            ...
            protected override void OnOpen()
            {
                if (TangledMapViewMod.Instance != null)
                {
                    ...
                    try
                    {
                        var msg = TangledMapViewMod.Instance.PrepareAssetMessage("Map_Knight_Pin_Compass");
                        if (msg != null) Send(msg);
                        msg = TangledMapViewMod.Instance.PrepareAssetMessage("pin_bench");
                        if (msg != null) Send(msg);
                    }
                    catch (Exception e)
                    {
                        TangledMapViewMod.Instance.Log(e);
                        throw;
                    }
                }
            }
